 ...
 */
In.add('KindEditorCss',{path:'/static/js/lib/kindeditor/themes/default/default.css'});
In.add('KindEditorCore',{path:'/static/js/lib/kindeditor/kindeditor-all-min.js',type:'js',charset:'utf-8'});
In.add('KindEditor',{path:'/static/js/lib/kindeditor/lang/zh-CN.js',type:'js',charset:'utf-8',rely:['KindEditorCss','KindEditorCore']});

In.add('ChosenCss',{path:'/static/css/chosen.css'});
In.add('Chosen',{path:'/static/js/lib/chosen.min.js',type:'js',charset:'utf-8',rely:['ChosenCss']});

In.add('DateTimePickerCss',{path:'/static/css/datetimepicker.min.css'});
In.add('DateTimePicker',{path:'/static/js/lib/datetimepicker.min.js',type:'js',charset:'utf-8',rely:['DateTimePickerCss']});

In.add('WebUploaderCss',{path:'/static/js/lib/webuploader/webuploader.css'});
In.add('WebUploaderCore',{path:'/static/js/lib/webuploader/webuploader.nolog.min.js',type:'js',charset:'utf-8'});
In.add('McWebUploader',{path:'/static/js/lib/webuploader/mc.webuploader.js',type:'js',charset:'utf-8',rely:['WebUploaderCss','WebUploaderCore']});

In.add('DataTableCss',{path:'/static/js/lib/datatable/css/editor.bootstrap.min.css'});
In.add('DataTableCore',{path:'/static/js/lib/datatable/dataTables.editor.min.js',type:'js',charset:'utf-8'});
In.add('DataTable',{path:'/static/js/lib/datatable/editor.bootstrap.min.js',type:'js',charset:'utf-8',rely:['DataTableCss','DataTableCore']});

In.add('AreaCss',{path:'/static/js/lib/area/city-picker.css'});
In.add('AreaCore',{path:'/static/js/lib/area/city-picker.js',type:'js',charset:'utf-8'});
In.add('Area',{path:'/static/js/lib/area/main_area.js',type:'js',charset:'utf-8'});

In.add('Validate',{path:'/static/js/lib/validate.js',type:'js',charset:'utf-8'});

In.add('FreeWall',{path:'/static/js/lib/freewall.js',type:'js',charset:'utf-8'});

In.add('SlidesCss',{path:'/static/js/lib/slides/slides.css'});
In.add('SlidesCore',{path:'/static/js/lib/slides/slides.jquery.js',type:'js',charset:'utf-8'});
In.add('Slides',{path:'/static/js/lib/slides/mcSlides.js',type:'js',charset:'utf-8',rely:['SlidesCss','SlidesCore']});
